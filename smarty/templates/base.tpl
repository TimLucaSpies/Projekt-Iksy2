            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="warenkorb.php">
                        Warenkorb
                        {if isset($SESSION_warenkorbAnzahl) && $SESSION_warenkorbAnzahl > 0}
                        <span class="badge-s04">{$SESSION_warenkorbAnzahl}</span>
                        {/if}
                    </a>
                </li>
                <li class="nav-item">
                ...
                {if isset($SESSION_rolle) && $SESSION_rolle === 'admin'}
                <li class="nav-item">
...
<footer class="text-center">
    <div class="container">
        &copy; {$smarty.now|date_format:"%Y"} FC Schalke 04
        &nbsp;|&nbsp; <a href="#">Impressum</a>
